...
CreateProcessorAction::CreateProcessorAction(ValueTree processorToCreate, int trackIndex, int slot, Tracks &tracks, View &view, ProcessorGraph &processorGraph)
...
CreateProcessorAction::CreateProcessorAction(const PluginDescription &description, int trackIndex, int slot, Tracks &tracks, View &view, ProcessorGraph &processorGraph)
        : CreateProcessorAction(createProcessor(description), trackIndex, slot, tracks, view, processorGraph) {}

CreateProcessorAction::CreateProcessorAction(const PluginDescription &description, int trackIndex, Tracks &tracks, View &view, ProcessorGraph &processorGraph)

#include "SegmentedLevelMeter.h"

SegmentedLevelMeter::SegmentedLevelMeter() : LevelMeter(vertical) {
...
void SegmentedLevelMeter::drawMeterBars(Graphics &g, const LevelMeterSource *source) {

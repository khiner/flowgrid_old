...
struct ArrangeClasses {
    ...
    struct ArrangeClip : public Component,
        ...
        void paint(Graphics &g) override {
            ...
            const auto bg = getUIColourIfAvailable(LookAndFeel_V4::ColourScheme::UIColour::windowBackground).darker(
                    0.15f);
    ...
    struct ArrangeTrack : public Component,
        ...
        void paint(Graphics &g) override {
            ...
            g.drawText(state[IDs::name].toString(), r.removeFromLeft(clipX).reduced(4, 0), Justification::centredLeft,
                       true);
        }
